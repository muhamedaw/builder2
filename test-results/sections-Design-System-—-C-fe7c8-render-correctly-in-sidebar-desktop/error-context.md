...
- Name: sections.spec.js >> Design System — CSS tokens applied >> --surface variables render correctly in sidebar
- Location: tests\visual\sections.spec.js:68:3

# Error details

```
Error: A snapshot doesn't exist at C:\Users\Muhammed\Desktop\github\bulider\tests\visual\baselines\sections.spec.js-snapshots\ds-sidebar-surface-desktop-win32.png, writing actual.
```
