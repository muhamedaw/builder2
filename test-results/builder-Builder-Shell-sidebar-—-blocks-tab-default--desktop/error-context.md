...
- Name: builder.spec.js >> Builder Shell >> sidebar — blocks tab (default)
- Location: tests\visual\builder.spec.js:53:3

# Error details

```
Error: A snapshot doesn't exist at C:\Users\Muhammed\Desktop\github\bulider\tests\visual\baselines\builder.spec.js-snapshots\sidebar-blocks-desktop-win32.png, writing actual.
```
