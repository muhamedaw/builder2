...
- Name: sections.spec.js >> Design System — CSS tokens applied >> btn-primary uses --accent color
- Location: tests\visual\sections.spec.js:76:3

# Error details

```
Error: A snapshot doesn't exist at C:\Users\Muhammed\Desktop\github\bulider\tests\visual\baselines\sections.spec.js-snapshots\ds-btn-primary-desktop-win32.png, writing actual.
```
