...
- Name: builder.spec.js >> Builder Shell >> topbar — undo/redo buttons disabled on empty canvas
- Location: tests\visual\builder.spec.js:38:3

# Error details

```
Error: A snapshot doesn't exist at C:\Users\Muhammed\Desktop\github\bulider\tests\visual\baselines\builder.spec.js-snapshots\topbar-empty-history-desktop-win32.png, writing actual.
```
