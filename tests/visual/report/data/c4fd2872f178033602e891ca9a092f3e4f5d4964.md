...
- Name: builder.spec.js >> Builder Shell >> full builder — empty
- Location: tests\visual\builder.spec.js:66:3

# Error details

```
Error: A snapshot doesn't exist at C:\Users\Muhammed\Desktop\github\bulider\tests\visual\baselines\builder.spec.js-snapshots\builder-empty-desktop-win32.png, writing actual.
```
